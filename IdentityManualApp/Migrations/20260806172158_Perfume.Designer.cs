...
namespace IdentityManualApp.Migrations
{
    ...
    [Migration("20260806172158_Perfume")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IdentityManualApp.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("IdentityManualApp.Models.Fornecedor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IdentityManualApp.Models.Produto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PerfumesMVC.Models.ReceitaProduto", b =>
                {
                    ...
                    b.HasKey("ReceitaId", "ProdutoId");

                    b.HasIndex("ProdutoId");

                    b.ToTable("ReceitaProdutos");
                });

            modelBuilder.Entity("IdentityManualApp.Models.Produto", b =>
                {
                    b.HasOne("IdentityManualApp.Models.Fornecedor", "Fornecedor")
                        .WithMany("Produtos")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("IdentityManualApp.Models.ApplicationUser", null)
                        .WithMany()
